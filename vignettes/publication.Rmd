...
vignette: >
  %\VignetteIndexEntry{ifo Business Climate Index}
...
This vignette demonstrates how to access the ifo Business Climate data and reproduce some of the plots from the ifo [website](https://www.ifo.de/en/survey/ifo-business-climate-index-germany).
